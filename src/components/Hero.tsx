      ...
      <div class="w-full relative flex flex-col gap-4 pt-0">
        ...
        <div class="flex flex-col md:flex-row items-end gap-8 md:gap-4  pt-8 pb-10">
          ...
          <div class="w-full md:w-[400px] ml-0 md:ml-auto hidden md:block">
            <h6 class="text-[#F24347]">We engineer solutions !</h6>
            <p class="text-black/60">We create software that drive businesses forward –– covering the complete lifecycle of a digital product from design to development, and deployment.</p>
          </div>
        </div>
        ...
        <div class="w-full  block md:hidden py-8 px-2">
            <h5 class="text-[#F24347]">We engineer solutions !</h5>
            <p class="!text-[18px] text-black/60">We create software that drive businesses forward –– covering the complete lifecycle of a digital product from design to development, and deployment.</p>
          </div>
      </div>
    )
}