...
const componentStyle : string = "inline-block relative backdrop-blur-sm border border-black/10 rounded-full bg-size-[100%] object-cover bg-center bg-no-repeat";

export function Avatar (props: { Person: Person; Style:DynamicStyle }) {
    const [showFloating, setShowFloating] = createSignal (false);
    return (
        <span   class={`flex ${props.Style} ${componentStyle}`} 
