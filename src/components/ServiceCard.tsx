...
export function ServiceCard ( props : { Service : Service }) {
    const componentStyle = ` group relative flex flex-col gap-4 w-full h-[300px] md:h-[400px] text-black hover:text-white active:text-white
    ...
    return (
        <div class={componentStyle}>
            ...
            <span class="text-center text-[38px] md:text-[48px] block no-line-height">{props.Service.Title}</span>
